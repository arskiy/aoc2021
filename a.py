#
chunks = [i for i in open('input/2021/day10.txt', 'r').read().strip().splitlines()]
#
def check_syntax(ch):
  d = {'(': ')', '[': ']', '{': '}', '<': '>'}
...
print('Part 1 result is:', score1)
# Part 2:
print('Part 2 result is:', score_of_incomplete(chunks, inv_pos, stacks))
